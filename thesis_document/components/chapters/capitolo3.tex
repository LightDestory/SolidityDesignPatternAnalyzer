		...
		\begin{tikzpicture}
			\node (table) [inner sep=0pt] {
				...
				\begin{tabular}{p{0.21\linewidth} | p{0.74\linewidth}}
					...
					\textbf{Riferimenti} & {Codice di riferimento: \hyperref[appendix:access_restriction]{Appendice} \newline Bibliografia: \cite{maxwoe} \cite{cjgdev} \cite{fravoll}} \\
				\end{tabular}
			};
...
I \textit{Behavioral design pattern} propongono funzionalità e meccanismi di supporto per lo svolgimento delle operazioni del contratto.\par
		...
		\begin{tikzpicture}
			\node (table) [inner sep=0pt] {
				...
				\begin{tabular}{p{0.21\linewidth} | p{0.74\linewidth}}
					...
					\textbf{Riferimenti} & {Codice di riferimento: \hyperref[appendix:commit_and_reveal]{Appendice} \newline Bibliografia: \cite{maxwoe}} \\
				\end{tabular}
			};
			\draw [rounded corners=.5em] (table.north west) rectangle (table.south east);
		\end{tikzpicture}
		...
		\begin{tikzpicture}
			\node (table) [inner sep=0pt] {
				...
				\begin{tabular}{p{0.21\linewidth} | p{0.74\linewidth}}
					...
					\textbf{Riferimenti} & {Codice di riferimento: \hyperref[appendix:guardcheck]{Appendice} \newline Bibliografia: \cite{fravoll}} \\
				\end{tabular}
			};
			\draw [rounded corners=.5em] (table.north west) rectangle (table.south east);
		\end{tikzpicture}
		...
		\begin{tikzpicture}
			\node (table) [inner sep=0pt] {
				...
				\begin{tabular}{p{0.21\linewidth} | p{0.74\linewidth}}
					...
					\textbf{Riferimenti} & {Codice di riferimento: \hyperref[appendix:oracle]{Appendice} \newline Bibliografia: \cite{maxwoe} \cite[Basato su Oraclize]{fravoll}} \\
				\end{tabular}
			};
			\draw [rounded corners=.5em] (table.north west) rectangle (table.south east);
		\end{tikzpicture}
		...
		\begin{tikzpicture}
			\node (table) [inner sep=0pt] {
				...
				\begin{tabular}{p{0.21\linewidth} | p{0.74\linewidth}}
					...
					\textbf{Riferimenti} & {Codice di riferimento: \hyperref[appendix:pull_over_push]{Appendice} \newline Bibliografia: \cite[SendingFunds]{maxwoe} \cite{fravoll}} \\
				\end{tabular}
			};
			\draw [rounded corners=.5em] (table.north west) rectangle (table.south east);
		\end{tikzpicture}
		...
		\begin{tikzpicture}
			\node (table) [inner sep=0pt] {
				...
				\begin{tabular}{p{0.21\linewidth} | p{0.74\linewidth}}
					...
					\textbf{Riferimenti} & {Codice di riferimento: \hyperref[appendix:randomness]{Appendice} \newline Bibliografia: \cite{fravoll}} \\
				\end{tabular}
			};
			\draw [rounded corners=.5em] (table.north west) rectangle (table.south east);
		\end{tikzpicture}
		...
		\begin{tikzpicture}
			\node (table) [inner sep=0pt] {
				...
				\begin{tabular}{p{0.21\linewidth} | p{0.74\linewidth}}
					...
					\textbf{Riferimenti} & {Codice di riferimento: \hyperref[appendix:state_machine]{Appendice} \newline Bibliografia: \cite{maxwoe}} \\
				\end{tabular}
			};
			\draw [rounded corners=.5em] (table.north west) rectangle (table.south east);
		\end{tikzpicture}
			...
			\begin{tikzpicture}
				\node (table) [inner sep=0pt] {
					...
					\begin{tabular}{p{0.21\linewidth} | p{0.74\linewidth}}
						...
						\textbf{Riferimenti} & {Codice di riferimento: \hyperref[appendix:memory_array_building]{Appendice} \newline Bibliografia: \cite{fravoll} \cite[Limit Storage]{9050163}} \\
					\end{tabular}
				};
				\draw [rounded corners=.5em] (table.north west) rectangle (table.south east);
			\end{tikzpicture}
			...
			\begin{tikzpicture}
				\node (table) [inner sep=0pt] {
					...
					\begin{tabular}{p{0.21\linewidth} | p{0.74\linewidth}}
						...
						\textbf{Riferimenti} & {Codice di riferimento: \hyperref[appendix:string_equality_comparison]{Appendice} \newline Bibliografia: \cite{fravoll}} \\
					\end{tabular}
				};
				\draw [rounded corners=.5em] (table.north west) rectangle (table.south east);
			\end{tikzpicture}
		...
		\begin{tikzpicture}
			\node (table) [inner sep=0pt] {
				...
				\begin{tabular}{p{0.21\linewidth} | p{0.74\linewidth}}
					...
					\textbf{Riferimenti} & {Codice di riferimento: \hyperref[appendix:tight_variable_packing]{Appendice} \newline Bibliografia: \cite{fravoll} \cite[Packing Variables]{9050163}} \\
				\end{tabular}
			};
			\draw [rounded corners=.5em] (table.north west) rectangle (table.south east);
		\end{tikzpicture}
			...
			\begin{tikzpicture}
				\node (table) [inner sep=0pt] {
					...
					\begin{tabular}{p{0.21\linewidth} | p{0.74\linewidth}}
						...
						\textbf{Riferimenti} & {Codice di riferimento: \hyperref[appendix:auto_deprecation]{Appendice} \newline Bibliografia: \cite{maxwoe} \cite{cjgdev}} \\
					\end{tabular}
				};
				\draw [rounded corners=.5em] (table.north west) rectangle (table.south east);
			\end{tikzpicture}
			...
			\begin{tikzpicture}
				\node (table) [inner sep=0pt] {
					...
					\begin{tabular}{p{0.21\linewidth} | p{0.74\linewidth}}
						...
						\textbf{Riferimenti} & {Codice di riferimento: \hyperref[appendix:mortal]{Appendice} \newline Bibliografia: \cite{maxwoe}} \cite{cjgdev} \\
					\end{tabular}
				};
				\draw [rounded corners=.5em] (table.north west) rectangle (table.south east);
			\end{tikzpicture}
...
{\section{Maintenance Design Pattern}
	I \textit{Maintenance design pattern} propongono, definendo modalità con cui strutturare il codice, meccanismi e funzionalità utili per il corretto funzionamento di uno smart-contract. \par
			...
			\begin{tikzpicture}
				\node (table) [inner sep=0pt] {
					...
					\begin{tabular}{p{0.21\linewidth} | p{0.74\linewidth}}
						...
						\textbf{Soluzione} & {Favorire il disaccoppiamento fra i dati e la logica del contratto creando di fatto un contratti separati. In genere il contratto dei dati viene denominato \textit{Storage} o \textit{Data Contract}.} \\ \hline
						...
						\textbf{Riferimenti} & {Codice di riferimento: \hyperref[appendix:data_segregation]{Appendice} \newline Bibliografia: \cite{maxwoe} \cite{cjgdev} \cite[Eternal Storage]{fravoll} \cite[Data Contract]{9050163}} \\
					\end{tabular}
				};
				\draw [rounded corners=.5em] (table.north west) rectangle (table.south east);
			\end{tikzpicture}
			\caption{Specifiche Data Segregation Pattern}
		\end{table}
	}
			...
			\begin{tikzpicture}
				\node (table) [inner sep=0pt] {
					...
					\begin{tabular}{p{0.21\linewidth} | p{0.74\linewidth}}
						...
						\textbf{Riferimenti} & {Codice di riferimento: \hyperref[appendix:register]{Appendice} \newline Bibliografia: \cite{maxwoe} \cite{cjgdev} \cite[Proxy Delegate]{fravoll} \cite[Proxy]{9050163}} \\
					\end{tabular}
				};
				\draw [rounded corners=.5em] (table.north west) rectangle (table.south east);
			\end{tikzpicture}
			\caption{Specifiche Register/Relay Pattern}
		\end{table}
	}
}

{\section{Security Design Pattern}
	I \textit{Security design pattern} propongono meccanismi utili a mitigare le possibili vulnerabilità di sicurezza. \par
	...
	{\subsection{Balance Limit Pattern}
		Il \textit{Balance Limit} pattern propone un meccanismo per contenere i possibili danni o compromissioni che possono affliggere l’utente in caso di bug nel codice o exploit di vulnerabilità non ancora identificate e mitigate.\par
		...
		\begin{table}[H]
			...
			\begin{tikzpicture}
				\node (table) [inner sep=0pt] {
					\def\arraystretch{1.5}
					\begin{tabular}{p{0.21\linewidth} | p{0.74\linewidth}}
						\textbf{Problema} & {Come per qualsiasi software, il funzionamento di uno smart-contract può essere compromesso da bug nel codice o da problemi di sicurezza ancora sconosciuti. Un malfunzionamento del contratto può causare danni irreparabili all'utente, come ad esempio la perdita di denaro.} \\ \hline
						...
						\textbf{Riferimenti} & {Codice di riferimento: \hyperref[appendix:balance_limit]{Appendice} \newline Bibliografia: \cite{maxwoe} \cite{8327565}} \\
					\end{tabular}
				};
				\draw [rounded corners=.5em] (table.north west) rectangle (table.south east);
			\end{tikzpicture}
			\caption{Specifiche Balance Limit Pattern}
		\end{table}
	}
	{\subsection{Check Effects Interactions Pattern}
		...
		avvenire quando il contratto comunica con un’entità, utente o smart-contract, esterno.
		\begin{table}[H]
			\centering
			\begin{tikzpicture}
				\node (table) [inner sep=0pt] {
					...
					\begin{tabular}{p{0.21\linewidth} | p{0.74\linewidth}}
						...
						\textbf{Soluzione} & {Identificate le funzioni che eseguono chiamate a entità terze, per cui l'incertezza relative al flusso di controllo è la potenziale causa di vulnerabilità, è possibile agire come segue: aggiornare lo stato interno del contratto prima di eseguire la chiamata all'entità esterna.} \\ \hline
						\textbf{Riconoscimento} & {Individuare l'esecuzione di chiamate esterne, ovvero l'utilizzo delle funzioni \textit{call()}, \textit{send()} e \textit{transfer()}, precedute da un'istruzione di assegnamento.} \\ \hline
						\textbf{Riferimenti} & {Codice di riferimento: \hyperref[appendix:check_effects_interactions]{Appendice} \newline Bibliografia: \cite{maxwoe} \cite{fravoll} \cite{8327565}} \\
					\end{tabular}
				};
				\draw [rounded corners=.5em] (table.north west) rectangle (table.south east);
			\end{tikzpicture}
	...
	L'\textit{Emergency Stop} pattern, noto anche come \textit{Circuit Breaker}, propone un meccanismo per implementare un interruttore software, capace di abilitare o disabilitare l'esecuzione di alcune funzionalità del contratto.\par
	Poiché è l'azionamento dell'interruttore è un operazione critica, la funzionalità è riservata al proprietario del contratto e per questo motivo l’accesso a tale metodo viene spesso gestito attraverso un Authorization pattern design.
	\begin{table}[H]
		\centering
		\begin{tikzpicture}
			\node (table) [inner sep=0pt] {
				\def\arraystretch{1.5}
				\begin{tabular}{p{0.21\linewidth} | p{0.74\linewidth}}
					\textbf{Problema} & {Nella blockchain Ethereum, una volta pubblicato un contratto, quest'ultimo viene eseguito viene eseguito autonomamente senza alcun controllo sulla sua esecuzione. Non vi è la possibilità di interromperne l'esecuzione totale o parziale delle funzionalità del contratto in caso di bug o problemi di sicurezza.} \\ \hline
					\textbf{Soluzione} & {Implementare un interruttore software che abiliti o disabiliti l'esecuzione delle funzionalità del contratto.} \\ \hline
					\textbf{Riconoscimento} & {Data la libertà implementativa, il riconoscimento di questo design pattern si basa sulla ricerca di un'istruzione di flip di una variabile di stato booleana.} \\ \hline
					\textbf{Riferimenti} & {Codice di riferimento: \hyperref[appendix:emergency_stop]{Appendice} \newline Bibliografia: \cite{maxwoe} \cite[Circuit Breaker]{cjgdev} \cite{fravoll} \cite{8327565}} \\
				\end{tabular}
			};
			\draw [rounded corners=.5em] (table.north west) rectangle (table.south east);
		\end{tikzpicture}
		\caption{Specifiche Emergency Stop Pattern}
	\end{table}
}
	{\subsection{Mutex Pattern}
	Il \textit{Mutex} pattern propone un meccanismo per mitigare le possibili vulnerabilità di \textit{rientranza}. Un attacco basato sulla rientranza consiste nell'invocare nuovamente una funzionalità  prima ancora che la sua prima esecuzione, e quindi l'aggiornamento dello stato interno del contratto, venga completata. \par
	Il meccanismo proposto dal pattern si basa su un semplice blocco basato sul concetto di \textit{semaforo con mutua esclusione}.
	\begin{table}[H]
		\centering
		\begin{tikzpicture}
			\node (table) [inner sep=0pt] {
				...
				\begin{tabular}{p{0.21\linewidth} | p{0.74\linewidth}}
					...
					\textbf{Riconoscimento} & {Data la libertà implementativa, il riconoscimento di questo design pattern si basa sulla ricerca della definizione e utilizzo di un modifier denominato in modo particolare, come ad esempio \textit{NoReentrancy}.} \\ \hline
					\textbf{Riferimenti} & {Codice di riferimento: \hyperref[appendix:mutex]{Appendice} \newline Bibliografia: \cite{maxwoe} \cite{cjgdev}, \cite{8327565}} \\
				\end{tabular}
			};
			\draw [rounded corners=.5em] (table.north west) rectangle (table.south east);
		\end{tikzpicture}
		\caption{Specifiche Mutex Pattern}
	\end{table}
}
		...
		\begin{tikzpicture}
			\node (table) [inner sep=0pt] {
				...
				\begin{tabular}{p{0.21\linewidth} | p{0.74\linewidth}}
					...
					\textbf{Soluzione} & {Implementare un limite al numero di esecuzione di una funzionalità in un definito quanto di tempo attraverso il concetto di \textit{function modifiers} di Solidity. Generalmente il meccanismo di conteggio può essere implementato attraverso una variabile di stato contatore e una funzione di \textit{reset()}. } \\ \hline
					\textbf{Riconoscimento} & {Data la libertà implementativa, il riconoscimento di questo design pattern si basa sulla ricerca della definizione e utilizzo di un modifier denominato in modo particolare, come ad esempio \textit{RateLimited}.} \\ \hline
					\textbf{Riferimenti} & {Codice di riferimento: \hyperref[appendix:rate_limit]{Appendice} \newline Bibliografia: \cite{maxwoe} \cite{cjgdev} \cite{8327565}} \\
				\end{tabular}
			};
			\draw [rounded corners=.5em] (table.north west) rectangle (table.south east);
		\end{tikzpicture}
		\caption{Specifiche Rate Limit Pattern}
	\end{table}
}
	...
	\begin{table}[H]
		...
		\begin{tikzpicture}
			\node (table) [inner sep=0pt] {
				\def\arraystretch{1.5}
				\begin{tabular}{p{0.21\linewidth} | p{0.74\linewidth}}
					\textbf{Problema} & {Si immagini l'esigenza di mettere in uno stato di manutenzione temporanea il contratto per poi ritornare in servizio senza dover cambiare indirizzo. Durante la manutenzione il contratto seppur attivo deve rifiutare qualsiasi richiesta pervenuta.} \\ \hline
					...
					\textbf{Riferimenti} & {Codice di riferimento: \hyperref[appendix:rejector]{Appendice} \newline Bibliografia: \cite{cjgdev}} \\
				\end{tabular}
			};
			\draw [rounded corners=.5em] (table.north west) rectangle (table.south east);
		\end{tikzpicture}
		\caption{Specifiche Rejector Pattern}
	\end{table}
}
}